...
class AksisDataStream(object):
    ...
    def vocabulary(self):
        """load vocabulary"""
        vocab = VocabularyFromWordList(self.vocabulary_data_dir, top_words=self.top_words, special_words=special_words).build_vocabulary_from_words_list(self.words_list_file)
        return vocab
